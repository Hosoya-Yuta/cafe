<header class="contact_header">
    <nav class="nav">
        ...
        <div class='g_nav'>
            <a class='menu _click' href="index.php#photo" v-on="click: toIntro" v-transition>はじめに</a>
            <a class='menu _click' href="index.php#cafe_exp" v-on="click: toExp" v-transition>体験</a>
